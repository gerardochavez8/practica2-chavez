				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th>Dirección</th>
							<th>Telefono</th>
							<th><button ng-click="add()" class="btn btn-success btn-sm"><i class="fa fa-file-o"
										aria-hidden="true"></i></button>&nbsp;Nuevo</th>
						</tr>
					</thead>
					<tbody>
						<tr ng-repeat="persona in personas track by $index">
							...
							<td>
								...
								<button class="btn btn-danger btn-sm" ng-click="delete(persona.id)"
									data-toggle='confirmation' data-singleton='true' data-placement='top'> <i
										class="fa fa-times" aria-hidden="true"></i>Borrar</button>
							</td>
						</tr>
					</tbody>
				</table>
